...
/// <summary>
/// GetShoppingListById feature slice for retrieving a single shopping list.
/// </summary>
public static class GetShoppingListById
{
    ...
    internal sealed class Handler(ShoppingListDbContext context, ILogger<Handler> logger) : IRequestHandler<Query, Result<Response>>
    {
