...
/// <summary>
/// DeleteShoppingListItem feature slice for removing an item from a shopping list.
/// </summary>
public static class DeleteShoppingListItem
{
    ...
    internal sealed class Handler(ShoppingListDbContext context, ILogger<Handler> logger) : IRequestHandler<DeleteShoppingListItemCommand, Result<bool>>
    {
