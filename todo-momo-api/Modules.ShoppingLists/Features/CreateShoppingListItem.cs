...
/// <summary>
/// CreateShoppingListItem feature slice for adding an item to an existing shopping list.
/// </summary>
public static class CreateShoppingListItem
{
    ...
    internal sealed class Handler(ShoppingListDbContext context, ILogger<Handler> logger) : IRequestHandler<Command, Result<Guid>>
    {
