...
/// <summary>
/// DeleteShoppingList feature slice for deleting a shopping list and its items.
/// </summary>
public static class DeleteShoppingList
{
    ...
    internal sealed class Handler(ShoppingListDbContext context, ILogger<Handler> logger) : IRequestHandler<DeleteShoppingListCommand, Result<bool>>
    {
